...
- 一般單一航空器墜毀原則為 `B` 至 `A-`；核心板塊的大型民航載客機或大型軍民運輸機若全機罹難，可直接列 `A`，但少數人搭乘的私人小型機、商務機或訓練機不適用。除此外，須有全球停飛、連續事故、多架航空器、國家領導層、戰爭升級或重大制度衝擊才可突破 `A-`。劫機、恐攻與蓄意撞擊另依國家安全及國際秩序影響評級，可達 `A`、`A+` 或 `S`。
