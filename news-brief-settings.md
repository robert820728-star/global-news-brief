...
- 非核心地區事故通常需死亡 100 人以上才進入 A- 候選，死亡 200 人以上或另有重大系統衝擊才進 A；核心板塊重大公共運輸或基礎設施事故可依制度失靈、全國性追責及直接公共利益例外升級。
- 大範圍必須是跨第一級行政區、全國關鍵系統或多國的直接影響；警戒覆蓋、行政區總人口、圖片震撼度及媒體形容不得代替實際影響。
- 災害、疫情或公共安全事件列為 `A-` 以上時，`selection.reason` 必須寫出觸發的量化指標與範圍層級。
- 一般航空事故依傷亡、載運規模、公共運輸安全與制度影響評級，再套用既有核心板塊關聯權重，不另設「全機罹難」或特定國家的航空例外。核心板塊大型空難可依重大事故通則列 `A`；非核心地區單一普通空難若未達大量死亡或重大結構性影響，原則不超過 `A-`。劫機、恐攻與蓄意撞擊依國家安全及國際秩序影響評級。涉及戰爭、交戰、軍事打擊或區域安全升級的航空事件必須放入國際／全球板塊，不得當作地方航空事故處理。
