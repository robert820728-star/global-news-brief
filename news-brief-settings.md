...
- 「大量死亡」預設指同一事件已確認死亡 100 人以上；非核心地區的地方事故死亡 20–99 人通常為 B／B+，不得只靠傷亡數進入 A。
- 航空、海運、鐵路、公路、工業氣爆、火災、倒塌與踩踏等單一國家地方型重大事故共用同一規則：在非核心／國際板塊通常為 `B`／`B+`；死亡 100 人以上可因大量死亡列 `A-`，但單靠傷亡不得自動列 `A`。
