...
2. Use the GitHub connector to request `https://api.github.com/repos/robert820728-star/global-news-brief/git/ref/heads/main?cache_bust=<nonce-a>` and read `object.sha`. With the other nonce, request `https://api.github.com/repos/robert820728-star/global-news-brief/commits/main?cache_bust=<nonce-b>` and read `sha`.
